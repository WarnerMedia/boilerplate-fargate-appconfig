...
echo ""
read -p "Enable AppConfig Freeform configuration (Default: $ENABLE_FREEFORM): " enable_freeform
echo "Current AppConfig Freeform configuration value: ${enable_freeform:-$ENABLE_FREEFORM}"

echo ""
read -p "AppConfig Freeform configuration format (Default: $FREEFORM_FORMAT): " freeform_format
echo "Current AppConfig Freeform configuration format value: ${freeform_format:-$FREEFORM_FORMAT}"

echo ""
read -p "Enable AppConfig Feature Flags configuration (Default: $ENABLE_FEATURE_FLAG): " enable_feature_flag
echo "Current AppConfig Feature Flag configuration value: ${enable_feature_flag:-$ENABLE_FEATURE_FLAG}"
